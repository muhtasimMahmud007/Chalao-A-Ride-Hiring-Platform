...
class MyUserManagerEmployee(BaseUserManager):
...
class MyUserEmployee(AbstractBaseUser):
    ...
    vehicle_id = models.TextField(default=None,null=True,blank=True)

    objects = MyUserManagerEmployee()
